...
(function () {
  ...
  class SimpleLightbox {
    ...
    init() {
      ...
      // Collect all images
      this.images = Array.from(lightboxImages).map((img) => ({
        src: img.src,
        alt: img.alt || "",
      }));
    ...
    createLightboxHTML() {
      const html = `
        <div id="lightbox-overlay" class="simple-lightbox-overlay" aria-hidden="true">
          <button id="lightbox-close" class="simple-lightbox-close" aria-label="Close image viewer">×</button>
          <div id="lightbox-container" class="simple-lightbox-container">
            <button id="lightbox-prev" class="simple-lightbox-nav simple-lightbox-prev" aria-label="Previous image">‹</button>
            <div class="simple-lightbox-stage">
              <img id="lightbox-image" class="simple-lightbox-image" src="" alt="" />
            </div>
            <button id="lightbox-next" class="simple-lightbox-nav simple-lightbox-next" aria-label="Next image">›</button>
          </div>
        </div>
      `;
